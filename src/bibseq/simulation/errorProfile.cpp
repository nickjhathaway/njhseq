...
char mismatchProfile::mutate(char firstBase, bib::randomGenerator &gen,
...
void mismatchProfile::mutateInPlace(char &firstBase, bib::randomGenerator &gen,
                                 const std::vector<char> &mutateTo) const {
  double sum = 0;
...
void mismatchProfile::mutateSeqInPlace(std::string &seq, bib::randomGenerator &gen,
...
void mismatchProfile::mutateSeqInPlaceSameErrorRate(
    std::string &seq, bib::randomGenerator &gen, const std::vector<char> &mutateTo,
    double errorRate) {
...
std::string mismatchProfile::mutateSeqSameErrorRate(
    const std::string &seq, bib::randomGenerator &gen,
