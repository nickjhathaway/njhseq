...
/**@brief for scoring a primer with amibigous bases against sequence reads
 * @todo consider scoring all ambigious bases in ref negative
 */
void substituteMatrix::setWithDegenScoringNoNInRef(){
	setWithZeros();
	mat_['N']['A'] = -2;
	mat_['N']['a'] = -2;
	mat_['n']['A'] = -2;
...
substituteMatrix substituteMatrix::createDegenScoreMatrixNoNInRef(){
	substituteMatrix degen;
	degen.setWithDegenScoringNoNInRef();
	return degen;
}
